...
public class MostLeastOrderedHalfMealStrategy implements SortStrategy {

	@Override
	public TreeMap<Product, Double> sort(ArrayList<Order> orders) {
		// Création d'une collection avec tous les produits (ici des half meal uniquement à partir de Orders)
